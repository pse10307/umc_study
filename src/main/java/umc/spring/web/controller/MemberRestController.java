...
public class MemberRestController {
    ...
    @Operation(summary = "특정 멤버의 리뷰 목록 조회 API",description = "특정 가게의 멤버들의 목록을 조회하는 API이며, 페이징을 포함합니다. query String 으로 page 번호를 주세요")
    ...
    public ApiResponse<MemberResponseDTO.ReviewPreViewListDTO> getReviewList(@ExistMember @PathVariable(name = "memberId") Long memberId, @RequestParam(name = "page") Integer page){
        ...
        Page<Review> reviewList = memberQueryService.getReviewList(memberId, newpage);
